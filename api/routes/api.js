...
router.post("/restaurants", auth, ctrlRestaurants.createRestaurant);
router.put("/restaurants/:id", auth, isOwnerOrAdmin(Restaurant), ctrlRestaurants.updateRestaurant);
...
router.post("/restaurants/:idrest/reviews", auth, ctrlReviews.postReview);
